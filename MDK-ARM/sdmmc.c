...
/**
  ...
  *
  *  移植: VIT6 -> VGT6, SDMMC2_CK: PD6 -> PC1
  *
  ******************************************************************************
  * @attention
  *
...
void HAL_SD_MspInit(SD_HandleTypeDef* sdHandle)
{
  ...
  */
    ...
    __HAL_RCC_GPIOC_CLK_ENABLE();    /* VGT6: PC1 需要 GPIOC */
    __HAL_RCC_GPIOB_CLK_ENABLE();
    __HAL_RCC_GPIOD_CLK_ENABLE();
    /**SDMMC2 GPIO Configuration (VGT6)
    PC1      ------> SDMMC2_CK     ← 原VIT6是PD6, 这里改为PC1
    PB14     ------> SDMMC2_D0
    PB15     ------> SDMMC2_D1
    PD7      ------> SDMMC2_CMD
    ...
    */
    ...
    /* VGT6改动: PC1 -> SDMMC2_CK, AF12 (原来是 PD6 AF11) */
...
void HAL_SD_MspDeInit(SD_HandleTypeDef* sdHandle)
{
  ...
  /* USER CODE END SDMMC2_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOC, GPIO_PIN_1);    /* 原来是 GPIOD PIN_6 */
